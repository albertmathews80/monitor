      ...
      <div className="home-container justify-content-between d-flex col contentContainer">
        <div className="col-12 col-md-6">
          <div className="d-flex flex-column mt-4">
            <h3 style={{ color: "#000", fontWeight: 600, fontSize: "23px" }}>
              DATA
            </h3>
                  ...
                  return (
                    <Link to={data.link} key={i}>
                      ...
                      >
                        <img
                          src={
                            data.id === hoverDataNav ? data.image1 : data.image
                          }
                          alt="Dashboard"
                ...
                <select className={classes.selectVariable}>
                  ...
                  <option>Select Variable</option>
                    ...
                    >
                      <img
                        src={
                          !isHoveredThreshold ? clipIconBlack : clipIconWhite
                        }
                      />
                  ...
                  <div className="d-flex justify-content-center mt-3">
                    <div
                      className={[`d-flex`, `flex-column`, `mr-3`].join(" ")}
                    >
                      <label
                        className={[
                          `noMarginBottom`,
              ...
              >
                ...
                <div className="pt-3 container">
                  <div className="d-flex align-items-center">
                    ...
                    <input
                      type="text"
                      className={classes.popUpFormInput1}
                      placeholder="Report 1"
                    />
                  </div>
                  ...
                  <div className="d-flex mt-3 align-items-center">
                    ...
                    <div className="row flex-column align-items-center">
                      <div
                        class={[classes.customSelect1, classes.solid1].join(
                          " "
                        )}
                      >
                        <select
                ...
                <div className="pt-3 container">
                  ...
                  <div className="d-flex mt-3 align-items-center">
                    ...
                    <div
                      ...
                      style={{ transform: "translateX(-3px)", flex: 1 }}
                    >
                      <div
                        class={[classes.customSelect1, classes.solid1].join(
                          " "
