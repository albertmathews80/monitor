  ...
  return (
    <div>
      ...
      <div className="contentContainer">
        <SecAppBar title="Sensors" subTitle="All Sensors" routes={routes} />
          ...
          >
            ...
            <div className="d-flex flex-wrap mt-4">
              {sensors.map((sensor, j) => {
                return (
                  <div
                    className={["col-2", classes.sensorDivContainer].join(" ")}
                  >
                    <div
                      key={j}
                      className={[
                                ...
                                return (
                                    <div className="col">
                                        <div
                                            ...
                                            onMouseLeave={handleRemoveHover}
                                        >
                                            <img alt="All Sensors" src={sensor.id === hover ? sensor.image1 : sensor.image} />
                                            <label className={[`noMarginBottom`, `mt-2`, classes.sensorTileLabel].join(" ")}>
                                                {sensor.title}
                                            </label>
                                        </div>
                                    </div>
