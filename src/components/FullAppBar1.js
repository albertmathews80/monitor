...
import Users from "../imagesAssets/user-32.png";
import Sensor from "../imagesAssets/sensor-32.png";
  ...
  return (
    <div className={classes.FullAppBarMainDiv}>
      <div className={[`d-flex`, `justify-content-between`].join(" ")}>
        <div
          className={[`col-4`, `d-flex`, classes.fullAppBarLeftDiv].join(" ")}
        >
        ...
        <div
          ...
          style={{ padding: "15px", transform: "translate(-10px, -3px)" }}
        >
          {dashboardTopTiles.map((item, i) => {
            return (
              <div className="col-md-6">
                ...
                >
                  <div
                    style={{ padding: "15px", height: "97px" }}
